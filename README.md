...
Swagger API documentation for [Waibu Web Framework](https://github.com/ardhi/waibu)
...
```bash
$ npm install waibu-swagger waibu-rest-api waibu
```

Next, open the file located at ```{data-dir}/config/.plugins``` and add ```waibu-swagger``` , ```waibu-rest-api``` and ```waibu```

## Documentations

- [Config Object](wiki/CONFIG.md)
- [API](https://ardhi.github.io/waibu-swagger)
